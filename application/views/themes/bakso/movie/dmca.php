									<p class="lead">
										<?php echo strip_tags(base_url()); ?> respects the intellectual property of others. MovieHeadline.Us takes matters of Intellectual Property very seriously and is committed to meeting the needs of content owners while helping them manage publication of their content online.
									</p>
									<p>
										It should be noted that
										<a title="<?php echo strip_tags($this->session->userdata('namadomain')); ?>" href="<?php echo base_url();?>">
											<?php echo $this->session->userdata('namadomain');?>
										</a> is a simple search engine of videos available at a wide variety of third party websites.
									</p>
									<p>
										Any videos shown on third party websites are the responsibility of those sites and not
										<?php echo $this->session->userdata('namadomain');?>. We have no knowledge of whether content shown on third party websites is or is not authorized by the content owner as that is a matter between the host site and the content owner. MovieBuzzer.Us does not host any content on its servers or network.
									</p>
									<p>
									...
									Attn: DMCA Office
									<br /> email to:
									<?php echo $this->config->item('email_contact');?>
										<p>
