            ...
            <section id="slider">
                <div id="full-slider-wrapper">
                    <div id="layerslider" style="width:100%;height:500px;">
						...
						<?php echo $sliderdata->original_name;?>
						<div class="ls-slide" data-ls="transition2d:1;timeshift:-1000;">
                            <img src="<?php echo base_url(); ?>assets/themes/<?php echo THEMESET;?>/images/sliderimages/bg.png" class="ls-bg" alt="Slide background"/>
                            ...
                            <img class="ls-l" src="<?php echo $this->tmdb->getImageURL('w780') . $sliderdata->backdrop_path; ?>" alt="layer 1" style="top:55px; left:700px; max-height:300px;" data-ls="offsetxin:right;durationin:3000; delayin:600;durationout:850;rotatexin:-90;rotatexout:90;">
