	...
	<style>
		div.playersasb div.registration{background:transparent none repeat scroll 0 0;}
	</style>
...
<div class="modal fade" id="modal-watch" tabindex="-1" role="dialog" aria-labelledby="modal-watch" aria-hidden="true">
        ...
        <div class="modal-content clearfix">
                ...
                <div class="modal-footer bg-info">
                        <a class="btn btn-danger" href="<?php echo base_url('movies/watch_download/'.$aff_link.'')?>"  title="Sign Up For Free" >Sign Up For Free</a>
                </div>
        </div>
</div>
