                    ...
                    <?php //pr($nowplay); ?>
					<h2 id='target' class="page-heading heading--outcontainer"><?=$title?> Movies</h2>
					<?php 
					$xx=1;
					$ix=0;
                        ...
                        <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--dark movie--test--<? if($xx%2==0){echo 'left';}else{echo 'right';}?>">
                                ...
                                <div class="movie__info">
                                    <a href='movie-page-left.html' class="movie__title"><?php echo $datanowplay->original_title;?></a>
                                    ...
                                    <div class="movie__rate">
                                        <div class="score" style="cursor: pointer; width: 130px;">
											<?=imgreate(round($datanowplay->vote_average));?>
										</div>
