                        ...
                        <div class="sitebar first-banner--left">
                            ...
                            <div class="category category--discuss category--count marginb-sm mobile-category ls-cat">
								...
								<ol>
									...
									?>
									<li><a class="category__item" href="#"><?php echo $PopularMovie->original_title;?></a></li>
									<? } ?>
								</ol>
							</div>
							...
							<?php foreach($termsmovie as $popix=>$termsdata){?>
								<li class="item-wrap"><a class="tags__item" href="#"><?php echo $termsdata['k_name']?></a></li>
							<? } ?>
							</ul>
                            <div class="category category--discuss category--count marginb-sm mobile-category ls-cat">
								...
								<li ><a class="category__item" href="#"><?php echo $PopularMovie->original_name;?></a></li>
								<? } ?>
								</ol>
							</div>
